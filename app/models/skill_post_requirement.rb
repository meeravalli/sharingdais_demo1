class SkillPostRequirement < ActiveRecord::Base
  ...
  attr_accessible :service_id, :city_id, :location_id, :sub_category_id, :user_id, :charges, :description, :fri, :home_service, :latitude, :longitude, :mon, :sat, :seeker_provider, :service_in_one_line, :sun, :thu, :tue, :wed, :skill
